...
export const NEWS = [
  {
    ...
    emoji: "🎬",
    color: "bg-kidz-purple",
    title: "Краткосрочный проект: видео-презентация",
    text: "Представляем итог нашего краткосрочного проекта! В этом видео — всё самое яркое: как дети исследовали, творили, удивлялись и делали открытия вместе. Смотрите и вдохновляйтесь! ✨",
    videos: [
