          ...
          <div className="grid md:grid-cols-2 gap-10 mt-10">
            <div className="space-y-5">
              ...
              <p className="text-gray-600 leading-relaxed">
                Работаю по Образовательной программе дошкольного образования (ОПДО) МБДОУ д/с №272. Верю, что счастливый ребёнок — это успешный ребёнок.
              </p>
      ...
      <section id="achievements" className="relative z-10 py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-kidz-yellow/20 to-kidz-orange/10 border-2 border-kidz-yellow rounded-3xl p-6 mt-6">
            ...
            <p className="text-center text-gray-500 text-sm mb-5">Дипломы, грамоты и благодарности за профессиональные достижения</p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { src: "https://cdn.poehali.dev/projects/b4ae50f1-b43b-46af-8337-6ac7bde0d6f4/bucket/07cb6815-64c3-4e3e-8402-b471709a69b4.jpg", label: "I место — «Победы солнечный май», «Звёздочка наша», 2026" },
                ...
                { src: "https://cdn.poehali.dev/projects/b4ae50f1-b43b-46af-8337-6ac7bde0d6f4/bucket/5d48b5fe-b743-4869-a0de-32d440597c97.jpg", label: "Благодарность за подготовку победителей — «Новогоднее счастье», «Звёздочка наша», 2026" },
                ...
                <div
                  key={i}
                  onClick={() => setLightboxSrc(award.src)}
                  className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:scale-[1.02] transition-all duration-300 group cursor-zoom-in"
                >
                  <div className="relative overflow-hidden">
                    <img src={award.src} alt={award.label} className="w-full h-40 object-cover object-top group-hover:scale-105 transition-transform duration-300" />
                    <div className="absolute inset-0 bg-black/0 group-hover:bg-black/15 transition-colors flex items-center justify-center">
                      <div className="opacity-0 group-hover:opacity-100 transition-opacity bg-white/90 rounded-full p-2 shadow-lg">
                        <Icon name="ZoomIn" size={16} />
                      </div>
                  ...
                  <div className="px-3 py-2 text-xs text-gray-500 font-medium leading-snug">{award.label}</div>
                </div>
              ))}
            </div>
          </div>
