...
export const ACTIVITIES = [
  { emoji: "🎨", title: "Рисование", desc: "Развиваем творческое воображение и мелкую моторику через работу с красками, карандашами и различными техниками", color: "bg-kidz-pink" },
  { emoji: "🌍", title: "Окружающий мир", desc: "Знакомимся с природой, животными, растениями и явлениями окружающего мира", color: "bg-kidz-green" },
  { emoji: "🎵", title: "Музыка", desc: "Слушаем, поём, танцуем и играем на простых инструментах — развиваем музыкальный слух и ритм", color: "bg-kidz-purple" },
  { emoji: "⚽", title: "Физкультура", desc: "Подвижные игры, упражнения и эстафеты для укрепления здоровья и развития координации", color: "bg-kidz-orange" },
  { emoji: "🔢", title: "Математика", desc: "Счёт, формы, величины и логика — закладываем основы математического мышления в игровой форме", color: "bg-kidz-blue" },
  { emoji: "🗣️", title: "Развитие речи", desc: "Обогащаем словарный запас, учимся выражать мысли и слушать — основа успешного общения", color: "bg-kidz-yellow" },
  { emoji: "✂️", title: "Аппликация", desc: "Создаём яркие композиции из бумаги и природных материалов — развиваем аккуратность и фантазию", color: "bg-kidz-pink" },
  { emoji: "🏺", title: "Лепка", desc: "Работа с пластилином и глиной развивает пространственное мышление и тактильные ощущения", color: "bg-kidz-green" },
  { emoji: "🔬", title: "Экспериментирование", desc: "Простые опыты и эксперименты — воспитываем маленьких учёных, умеющих задавать вопросы", color: "bg-kidz-blue" },
  { emoji: "🎭", title: "Театрализация", desc: "Разыгрываем сказки и сценки — развиваем выразительность, уверенность и эмпатию", color: "bg-kidz-purple" },
  { emoji: "📖", title: "Обучение грамоте", desc: "Знакомимся с буквами, звуками и слогами — мягкая подготовка к школьному чтению и письму", color: "bg-kidz-orange" },
  { emoji: "💚", title: "Здоровьесбережение", desc: "Формируем привычки здорового образа жизни: гигиена, правильное питание, режим дня", color: "bg-kidz-green" },
  { emoji: "📚", title: "Художественная литература", desc: "Читаем, обсуждаем и пересказываем сказки и рассказы — развиваем любовь к книге и фантазию", color: "bg-kidz-yellow" },
];
